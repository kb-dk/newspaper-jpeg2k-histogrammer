 ...
 */
public class KakaduConvertToPgmMapper extends Mapper<LongWritable, Text, Text, Text> {

    private static Logger log = Logger.getLogger(KakaduConvertToPgmMapper.class);
